...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
    ...
    $errors=array();
    if(empty($name) OR empty($email) OR empty($ph) OR empty($area) OR empty($addr) OR empty($pwd) OR empty($rpwd)){
    ...
    if(count($errors)>0){
      ...
      $sql1="insert into admins values('$name','$email','$ph','$area','$addr','$pwd','$rpwd')";
      $final=$con->query($sql1);
      if($final==true){
       
      echo "<div class='alert alert-danger'>You are registered successful!</div>";
      }
      else
    ...
    <div class="admin mt-4"> 
        <form action="#" method="POST" class="admin-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <input type="text" name="name" class="form-control" required="" placeholder="Restaurant Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <select class="form-control " name="area" required="">
                <option value=""> -Select Restaurant Area- </option>
                  ...
                  <option value="Mogappair">Mogappait</option>
            ...
            <p class="text-center">For Login <a href="login1.php">Click Here</a> </p>
        </form>
